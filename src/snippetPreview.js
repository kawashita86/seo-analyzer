...
import createWordRegex from "yoastseo/src/stringProcessing/createWordRegex.js";
import { stripFullTags as stripHTMLTags } from "yoastseo/src/stringProcessing/stripHTMLTags.js";
import stripSpaces from "yoastseo/src/stringProcessing/stripSpaces.js";
import replaceDiacritics from "yoastseo/src/stringProcessing/replaceDiacritics.js";
import transliterate from "yoastseo/src/stringProcessing/transliterate.js";
import templates from "yoastseo/src/templates.js";
...
SnippetPreview.prototype.renderTemplate = function() {
    ...
    targetElement.innerHTML = snippetEditorTemplate( {
        ...
        i18n: {
            ...
            save:  "Close snippet editor",
            snippetPreview:  "Snippet preview",
            titleLabel:  "SEO title preview:",
            slugLabel:  "Slug preview:",
            metaDescriptionLabel:  "Meta description preview:",
            snippetPreviewDescription: "You can click on each element in the preview to jump to the Snippet Editor.",
            desktopPreviewMode:  "Desktop preview",
            mobilePreviewMode:  "Mobile preview",
            isScrollableHint:  "Scroll to see the preview content.",
        },
    } );
...
SnippetPreview.prototype.formatTitle = function() {
    ...
    if ( isEmpty( title ) ) {
        title =  "Please provide an SEO title by editing the snippet below.";
    }
...
SnippetPreview.prototype.formatMeta = function() {
    ...
    // As an ultimate fallback provide the user with a helpful message.
    if ( isEmpty( meta ) ) {
        meta = "Please provide a meta description by editing the snippet below.";
    }
